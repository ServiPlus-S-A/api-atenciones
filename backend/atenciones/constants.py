...
ERR_NOTAS_FINALES_OBLIGATORIAS = "Las notas finales son obligatorias para el cierre y deben tener un mínimo de 20 caracteres"
ERR_NOTAS_FINALES_CORTAS = "Falta añadir las notas finales de la atención: la nota debe tener más de 20 caracteres"
ERR_NOTAS_FINALES_LARGAS = "El mensaje de notas finales es muy extenso: Por favor resumir el mensaje para continuar"
